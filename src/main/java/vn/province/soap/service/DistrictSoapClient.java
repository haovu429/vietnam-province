...
public class DistrictSoapClient {
//    public static void main(String[] args) {
//        Logger logger = Logger.getLogger(DistrictSoapClient.class.getName());
//        try {
//            // Tạo yêu cầu SOAP
//            SOAPMessage soapMessage = createDistrictSOAPRequest();
//
//            // Gửi yêu cầu SOAP và nhận phản hồi
//            SOAPMessage soapResponse = callSOAPWebService("https://danhmuchanhchinh.gso.gov.vn/DMDVHC.asmx", soapMessage, "http://tempuri.org/DanhMucQuanHuyen");
//
...
//            List<DistrictInfo> provinceInfos = processResponse(response);
...
//    }
    ...
    public List<DistrictInfo> processResponse(String xmlResponse) {
        // Xử lý phản hồi
        ...
        try {
            ...
            for (int i = 0; i < tableNodes.getLength(); i++) {
                ...
                String maQuanHuyen = tableElement.getElementsByTagName("MaQuanHuyen").item(0).getTextContent();
                String tenQuanHuyen = tableElement.getElementsByTagName("TenQuanHuyen").item(0).getTextContent();
                ...
                districtInfo.setMaTinh(maTinh);
                districtInfo.setTenTinh(tenTinh);
                districtInfo.setMaQuanHuyen(maQuanHuyen);
                districtInfo.setTenQuanHuyen(tenQuanHuyen);
                districtInfo.setLoaiHinh(loaiHinh);
    ...
    public SOAPMessage createDistrictSOAPRequest() throws Exception {
        // Tạo SOAP Message
        ...
        SOAPElement districtCatalogElem = soapBody.addChildElement("DanhMucQuanHuyen", "tem");
        ...
        toDateElem.addTextNode("");
        tinhElem.addTextNode("");
        tenTinhElem.addTextNode("");
